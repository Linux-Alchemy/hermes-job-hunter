...
metadata:
  hermes:
    ...
    related_skills: [cover-letter-drafting, resume-drafting, career-document-rendering, job-discovery, source-registry-maintenance, employer-intelligence, application-packet]
---
